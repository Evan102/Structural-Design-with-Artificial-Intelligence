...
class GA:
    ...
    def selection(self):
        ...
        record = f"Round: {GA.round:3d}, score: {best_score:.4f}, design: {self._chromosome_to_section(graded[0])}"
        self.record_file.write(record + "\n")
        print(record)
    ...
    def run(self):
        self.record_file = open(self.env.record_path, "w")
